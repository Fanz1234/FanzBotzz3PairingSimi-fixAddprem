...
📆 *Days:* ${alice.msToDate(toMs(waktunya))}
...
reply(teks)
alice.sendMessage(nomernya,{text})
}
break
case 'delprem':
if (!isOwner) return onlyOwner()
